...
import { Currency, Status as UserStatus } from './enums';
...
export function getUserStatusDescription(userStatus)
{
    let statusDescription = getLangValue('DontNeedHelp');

    switch(userStatus) {
        case UserStatus.RegularHelp: 
            statusDescription = getLangValue('NeedRegularHelp');
            break;

        case UserStatus.Emergency: 
            statusDescription = getLangValue('Emergency');
            break;
    }
    return statusDescription;  
}

export function getUserStatusClassname(userStatus)
{
    let statusClassname = "green";
